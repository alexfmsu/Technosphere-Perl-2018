...
use Server::Commands::rm;
use Server::Commands::shell;
use Server::Commands::mkdir;

use Term::ANSIColor qw(:constants);

our %handler = (
    ls    => \&Server::Commands::ls::ls,
    mkdir    => \&Server::Commands::mkdir::mkdir,
    cd    => \&Client::Command::cd,
    cp    => \&Client::Command::cp,
    mv    => \&Client::Command::mv,
    rm    => \&Server::Commands::rm::rm,
    shell => \&Server::Commands::shell::shell,
);
